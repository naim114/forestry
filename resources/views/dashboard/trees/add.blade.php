        ...
        <div class="card-body">
            <form method="POST" action="{{ route('trees.add') }}">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input name="BlockX" type="number" class="form-control">
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label class="col-sm-2 col-form-label">BlockY</label>
                    <div class="col-sm-10">
                        <input name="BlockY" type="number" class="form-control">
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label class="col-sm-2 col-form-label">x</label>
                    <div class="col-sm-10">
                        <input name="x" type="number" class="form-control">
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label class="col-sm-2 col-form-label">y</label>
                    <div class="col-sm-10">
                        <input name="y" type="number" class="form-control">
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label class="col-sm-2 col-form-label">TreeNum</label>
                    <div class="col-sm-10">
                        <input name="TreeNum" type="text" class="form-control">
                    </div>
                </div>
                <div class="form-group row mb-4">
